...
import { Container, TextField, Button, Box, FormControl, Card, InputLabel, Select, MenuItem } from '@mui/material';
...
export default function Details() {
  ...
  const handleSubmit = async () => {
    if (service !== '' && plan !== "" && price && des !== "") {
      try {
        await api.post(`/api/addservice`, {
          servicename: service,
          description: des,
          plan: plan,
          price: price
    ...
    <Container component="main" sx={{ display: "flex", justifyContent: "center", alignItems: "center", mt: 6, width: "90vw", minWidth: "300px" }}>
      <Card sx={{ p: 4 }}>
        ...
        <FormControl fullWidth sx={{ mb: 3 }}>
          <InputLabel id="plans-service-label">Plan</InputLabel>
          <Select
